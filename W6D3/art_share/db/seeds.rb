...
collect = Collection.create!(name: 'collection1')
user1 = User.create!(username: 'robert')
user2 = User.create!(username: 'bill')
artwork1 = Artwork.create!(title: 'nighthawks', image_url: 'google.com', artist_id: user1.id, collection_id: 1)
artwork2 = Artwork.create!(title: 'mona lisa', image_url: 'google1.com', artist_id: user2.id, favorite: true,  collection_id: 1)
